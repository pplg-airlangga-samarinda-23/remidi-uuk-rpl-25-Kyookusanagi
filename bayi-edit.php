...
<body>
    ...
    <form action="" method="post">
        <div class="form-item">
            ...
            <input type="text" name="nama" id="nama" value="<?= $baby['nama'] ?>" required>
        </div>

        <div class="form-item">
            <label for="nama_ibu">Nama Ibu:</label>
            <input type="text" name="nama_ibu" id="nama_ibu" value="<?= $baby['nama_ibu'] ?>" required>
        </div>

        <div class="form-item">
            <label for="nama_ayah">Nama Ayah:</label>
            <input type="text" name="nama_ayah" id="nama_ayah" value="<?= $baby['nama_ayah'] ?>" required>
        </div>

        <div class="form-item">
            <label for="tanggal_lahir">Tanggal Lahir:</label>
            <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="<?= $baby['tanggal_lahir'] ?>" required>
        </div>
